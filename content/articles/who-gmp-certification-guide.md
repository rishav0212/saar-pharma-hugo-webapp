---
title: "WHO-GMP Certification in India: What Pharma Brands Need to Know"
date: 2025-01-20
meta_title: "WHO-GMP Certification Guide for Pharma Manufacturers | Saar Biotech"
meta_description: "A complete guide to WHO-GMP certification in India — what it means, why it matters for third-party pharma manufacturing, and how Saar Biotech maintains compliance in Baddi, HP."
keywords: ["WHO-GMP certification India", "GMP pharma manufacturer Baddi", "pharmaceutical third party manufacturing", "Schedule M compliance", "contract manufacturer India"]
cover_image: ""
...
This article breaks down WHO-GMP certification for pharmaceutical manufacturing in India — from its legal basis to what it means in practice for batch quality, documentation, and your product liability.
...
Every batch manufactured at Saar Biotech generates a complete **Batch Manufacturing Record (BMR)** and **Batch Packaging Record (BPR)**. These are stored for the legally mandated period and are available to clients on request as part of the product dossier.
...
1. **Drug Master File (DMF)** — filed by the manufacturer for the formulation
2. **Form 25 / 25A** — your brand's drug manufacturing permission (state-level)
3. **NOC from contract manufacturer** — permission to manufacture on behalf of your brand
4. **DCGI approval** — for new drug molecules not previously approved in India
5. **Labelling and artwork approval** — reviewed against Drugs & Cosmetics Act Schedule H/H1 requirements

> Saar Biotech's regulatory team assists with complete dossier preparation, state drug license NOCs, and DCGI filing support — so brand owners can focus on distribution rather than paperwork.

## Key Questions to Ask Your Contract Manufacturer

Before signing a manufacturing agreement, ask these:
