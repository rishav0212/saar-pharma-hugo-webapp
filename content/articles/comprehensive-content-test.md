---
title: "Comprehensive Guide to Quality Control in Pharmaceutical Contract Manufacturing"
date: 2026-05-22
last_updated: "May 2026"
meta_title: "Comprehensive Guide to QC in Pharma Contract Manufacturing | Saar Biotech"
meta_description: "A definitive guide to quality control in pharmaceutical contract manufacturing — covering WHO-GMP compliance, analytical testing, batch release protocols, data integrity, and how Saar Biotech maintains world-class QC standards in Baddi."
keywords: ["pharma quality control", "QC testing pharmaceutical", "third party manufacturing quality", "pharmaceutical analysis", "WHO-GMP compliance", "pharma contract manufacturing", "batch release protocol", "HPLC pharmaceutical testing", "certificate of analysis", "Schedule M compliance"]
cover_image: "/images/articles/pharma-qc-lab.png"
category: "Quality Assurance"
tags: ["Quality Control", "Compliance", "Laboratory Testing", "WHO-GMP", "Batch Release", "Data Integrity"]
author: "Saar Biotech Quality Assurance Team"
related_products: ["azithromycin-oral-solution", "paracetamol-suspension", "cholecalciferol-vitamin-d3-nano-shots"]
key_takeaways:
  - "Quality control in pharma manufacturing begins with **raw material qualification** — not at the final product stage."
  - "A WHO-GMP compliant manufacturer must maintain a complete **Batch Manufacturing Record (BMR)** for every batch produced."
  - "**HPLC (High-Performance Liquid Chromatography)** is the industry gold standard for assay testing and impurity profiling."
  - "The **Certificate of Analysis (COA)** is your legal shield — insist on one for every dispatched batch."
  - "Data integrity (21 CFR Part 11 / ALCOA+ principles) is now a primary focus of CDSCO and WHO inspections globally."
  - "Outsourcing manufacturing doesn't transfer quality liability — the brand owner remains **legally responsible** for every tablet."
external_refs:
  - source: "WHO"
    title: "WHO Good Manufacturing Practices for Pharmaceutical Products"
    url: "https://www.who.int/publications/i/item/9789240012097"
  - source: "CDSCO India"
    title: "Schedule M — GMP Requirements under Drugs & Cosmetics Act"
    url: "https://cdsco.gov.in/opencms/opencms/en/Drugs/Good-Manufacturing-Practices/"
  - source: "ICH"
    title: "ICH Q10: Pharmaceutical Quality System"
    url: "https://www.ich.org/page/quality-guidelines"
  - source: "USP"
    title: "United States Pharmacopeia — Quality Standards"
    url: "https://www.usp.org/resources/compendial-tools"
faqs:
  - q: "How does Saar Biotech ensure raw material quality before production begins?"
    a: "Every batch of Active Pharmaceutical Ingredient (API) and excipient undergoes a multi-step qualification process. Upon receipt, materials are quarantined and assigned a unique lot number. Representative samples are drawn by our QA team and tested in our in-house QC laboratory against all applicable pharmacopoeial standards (IP/BP/USP). Only materials that pass all identity, purity, assay, and microbiological tests receive a 'Released' status and are permitted onto the production floor."
  - q: "What analytical instruments do you use for batch testing?"
    a: "Our QC laboratory is equipped with High-Performance Liquid Chromatography (HPLC), Gas Chromatography (GC), UV-Vis spectrophotometers, Karl Fischer titrators, automated dissolution testing apparatus (USP Type I and II), friabilators, hardness testers, and class-100 laminar airflow workstations for microbial testing. All instruments are calibrated at defined intervals and linked to our ERP system under 21 CFR Part 11 compliant audit-trail software."
  - q: "Do you provide a Certificate of Analysis (COA) with every delivery?"
    a: "Yes. Every dispatched batch is accompanied by a comprehensive, signed Certificate of Analysis (COA) detailing the exact test results for assay, dissolution, related substances (impurities), uniformity of content, microbial limits, and all relevant physical parameters. The COA is issued by our Quality Control Manager and countersigned by our Qualified Person (QP)."
  - q: "Is your facility WHO-GMP certified?"
    a: "Yes. Our manufacturing plant at EPIP Phase-1, Baddi, Himachal Pradesh operates under a current WHO-GMP license under Schedule M of the Drugs and Cosmetics Act, 1940. We are subject to periodic inspections by the Himachal Pradesh State Drug Authority and welcome independent audits from our B2B partners."
  - q: "What is your Out-of-Specification (OOS) investigation process?"
    a: "Any result that falls outside its specification triggers an immediate OOS investigation under a Standard Operating Procedure (SOP) compliant with WHO and USFDA guidelines. Phase 1 is a laboratory investigation to rule out assignable laboratory errors. Phase 2 is a full manufacturing investigation involving review of the BMR, environmental logs, and raw material lots. The batch is quarantined until investigation is complete. If the OOS is confirmed, the batch is rejected and destroyed — never blended or reworked to pass."
  - q: "How do you maintain data integrity in your QC records?"
    a: "We follow ALCOA+ principles (Attributable, Legible, Contemporaneous, Original, Accurate, plus Complete, Consistent, Enduring, and Available). All electronic analytical data is generated by 21 CFR Part 11 compliant software with user-specific login, audit trails, and access controls. No original data is overwritten. All paper records use indelible ink with no correction fluid — corrections are made with a single strike-through, initialled, and dated."
draft: false
---
...
{{< callout type="info" title="What is a Qualified Person (QP)?" >}}
A Qualified Person is a legally designated individual under Schedule M (India) and EU GMP Directive responsible for certifying that each batch has been manufactured, controlled, and released in accordance with all applicable regulations. No batch may leave a WHO-GMP facility without QP release.
{{< /callout >}}
...
1. **Vendor Assessment:** Review of the vendor's GMP certification, audit history, and facility credentials.
2. **Sample Testing:** A minimum of three separate lots tested against full pharmacopoeial specifications.
3. **Audit (if required):** For critical APIs, an on-site facility audit by our QA team.
4. **Approved Vendor List (AVL):** Only vendors on the AVL are permitted to supply materials.

{{< callout type="warning" title="Brand Owner Alert" >}}
When choosing a contract manufacturer, always ask to see their **Approved Vendor List (AVL)** and ask specifically which API vendors they use for your formulation. A manufacturer using unqualified or price-driven API sources is a red flag, regardless of their GMP certificate.
{{< /callout >}}
...
![Advanced HPLC Setup at Saar Biotech QC Lab](/images/articles/pharma-quality-control.png)
...
{{< callout type="success" title="Industry Best Practice" >}}
...
- **A**ttributable — Who generated the data and when?
- **L**egible — Can it be read now and in the future?
- **C**ontemporaneous — Was it recorded at the time it was created?
- **O**riginal — Is this the first capture of the data (not a copy)?
- **A**ccurate — Does it reflect what actually happened?
...
{{< callout type="tip" title="Technology Differentiator" >}}
...
1. **Product Identification:** Name, strength, batch number, manufacturing date, expiry date
2. **All Pharmacopoeial Tests:** With the actual result vs. the specification limit
3. **Analytical Methods Used:** Reference to validated, pharmacopoeial or in-house methods
4. **Environmental Monitoring Summary:** For sterile/liquid products
5. **Qualified Person Declaration:** Certifying the batch meets all specifications
6. **Regulatory Reference:** License number, schedule compliance declaration
...
*[View manufacturing details for cholecalciferol-vitamin-d3-nano-shots](/products/cholecalciferol-vitamin-d3-nano-shots/)*

{{< callout type="warning" title="Liquid Oral Manufacturing — The Critical Differentiator" >}}
Liquid oral manufacturing carries significantly **higher contamination risk** than solid dosage manufacturing. Manufacturers without validated closed-system filling processes, validated cleaning procedures, and continuous environmental monitoring should not be considered for parenteral or even non-sterile liquid products.
{{< /callout >}}
...
*For enquiries regarding our manufacturing capabilities, analytical capabilities, or to request a product-specific dossier, please contact our business development team at [quotation@saarbiotech.com](mailto:quotation@saarbiotech.com).*
